...
public class GeneralSettingController {
    ...
    public String userAdministration(Model model) {
        ...
        model.addAttribute("emailAddress", settingsService.getSettingValue(SettingsService.EMAIL_FOR_WEEKLY_SUMMARY));
    ...
    public void changeEmailAddress(@RequestBody EmailChangeRequestObject emailChangeRequestObject) throws UserNotFoundException {
